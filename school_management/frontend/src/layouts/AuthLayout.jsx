...
const AuthLayout = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f3f0fa] relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md p-6">
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 animate-slide-up">
